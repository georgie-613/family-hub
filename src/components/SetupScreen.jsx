...
export default function SetupScreen({ onComplete }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // If offline or fetch fails during setup, still allow proceeding
      console.warn('Firebase connectivity check skipped:', err.message)
    }
    setLoading(false)
    onComplete({
      apiKey: apiKey.trim(),
      ...
      name: name.trim(),
      spouseName: spouseName.trim() || 'Wife'
    })
  }
      ...
      <div style={styles.card}>
        ...
        <div style={styles.logo}>
          <div style={styles.logoIcon}>
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="var(--jorge)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <section style={styles.section}>
            ...
            <div style={styles.field}>
              <label style={styles.label} htmlFor="spouse">Partner's Name</label>
              <input
                id="spouse"
                type="text"
                placeholder="e.g. Maria  (default: Wife)"
                value={spouseName}
          ...
          <section style={styles.section}>
            ...
            <p style={styles.hint}>
              Firebase Console → Project Settings → Web app → SDK setup
            </p>
            <div style={styles.field}>
            ...
            <div style={styles.field}>
              <label style={styles.label} htmlFor="projectId">Project ID *</label>
              <input
                id="projectId"
                type="text"
                placeholder="my-family-hub-abc123"
                value={projectId}
